...
# Datasets
train_dataset = CIFAR10(args.cifar10_dir, train=True, download=True,
                        transform=transform)
val_dataset = CIFAR10(args.cifar10_dir, train=False, download=True,
                        transform=transform)
test_dataset = CIFAR10(args.cifar10_dir, train=False, download=True,
                        transform=transform)
# DataLoaders
